(function(e, h) {
    ...
    function t(b, i, k) {
        if (k === h && b.nodeType === 1)
            if (k = "data-" + i.replace(ob, "-$1").toLowerCase(), k = b.getAttribute(k)
                , typeof k === "string") {
            try {
    ...
    function da(b) {
        ...
        i.remove();
        if (a === "none" || a === "") {
            oa = c.body.appendChild(oa || d.extend(c.createElement("iframe"), {
                frameBorder: 0,
                width: 0,
                height: 0
            }));
    ...
    function V(b, i, a) {
        ...
        for (ua(a, y.opts.specialEasing);
        w < c;
        w++)if (i = xa[w].call(y, b, a, y.opts))
            return i;
        wa(y, a);
        d.isFunction(y.opts.start) && y.opts.start.call(b, y);
        d.fx.timer(d.extend(e, {
            anim: y,
            queue: y.opts.queue,
            elem: b
        }));
    ...
    function ua(b, i) {
        ...
        var a, w, c, l, e;
        for (a in b)
            if (w = d.camelCase(a), c = i[w], l = b[a], d.isArray(l) && (c = l[1], k = b[a] = l[0], l = k)
                , a !== w && (b[w] = l, delete b[a]), (e = d.cssHooks[w]) && "expand"in e)for (a in l = e.expand(l), delete b[w], l)
    ...
    d.extend({
        Deferred: function(b) {
            var i = [["resolve", "done", d.Callbacks("once memory"), "resolved"], ["reject", "fail", d.Callbacks("once memory"), "rejected"], ["notify", "progress", d.Callbacks("memory")]], a = "pending", c = {
                state: function() {
                    return a
                },
                always: function() {
    ...
    d.support = function() {
        ...
        b = {
            leadingWhitespace: g.firstChild.nodeType ===
            3,
        ...
        d(function() {
            ...
            if (k) {
                ...
                if (e.getComputedStyle)
                    b.pixelPosition = (e.getComputedStyle(d, null) || {}).top !== "1%", b.boxSizingReliable = (e.getComputedStyle(d, null) || {
                    width: "4px"
                }).width === "4px", i = c.createElement("div"), i.style.cssText = d.style.cssText = "padding:0;margin:0;border:0;display:block;overflow:hidden;",
    ...
    d.extend({
        ...
        _queueHooks: function(b, a) {
            var k = a + "queueHooks";
            return d._data(b, k) || d._data(b, k, {
        ...
        val: function(b) {
            ...
            if (arguments.length)
                ...
                if (this.nodeType === 1 && (k = c ? b.call(this, k, e.val()) : b, k == null ? k = "" : typeof k === "number" ? k += "" : d.isArray(k) && (k = d.map(k, function(b) {
                    ...
                    ], !a ||!("set"in a) || a.set(this, k, "value") === h))this.value = k
            });
            else if (e) {
    ...
    d.event = {
        ...
        trigger: function(b, a, k, g) {
            if (!k ||!(k.nodeType === 3 || k.nodeType === 8)) {
                var f, l, j, p, v, o, q = b.type || b;
                j = [];
                if (!Ya.test(q + d.event.triggered) && (q.indexOf("!") >= 0 && (q = q.slice(0, -1), f=!0), q.indexOf(".") >= 0 && (j = q.split("."), q = j.shift(), j.sort()
                    ), k&&!d.event.customEvent[q] || d.event.global[q]))if (b = typeof b === "object" ? b[d.expando] ? b : new d.Event(q, b) : new d.Event(q), b.type = q, b.isTrigger=!0, b.exclusive = f, b.namespace = j.join(".")
                    , b.namespace_re = b.namespace ? RegExp("(^|\\.)" + j.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, j = q.indexOf(":") < 0 ? "on" + q : "", k) {
                    b.result = h;
                    if (!b.target)
                        b.target = k;
                    ...
                    if (!(p.trigger && p.trigger.apply(k, a)===!1)) {
                        ...
                        if (!g&&!b.isDefaultPrevented() && (!p._default || p._default.apply(k.ownerDocument, a)===!1)&&!(q === "click" && d.nodeName(k, "a")) && d.acceptData(k))
                            if (j && k[q] && (q !== "focus" && q !== "blur" || b.target.offsetWidth !== 0)&&!d.isWindow(k))(l = k[j]) && (k[j] = null)
                                , d.event.triggered = q, k[q](), d.event.triggered = h, l && (k[j] = l);
                        return b.result
                    }
                } else 
                ...
                for (a = 0; a < u.length&&!b.isPropagationStopped(); a++) {
                    ...
                    for (k = 0; k < g.matches.length&&!b.isImmediatePropagationStopped(); k++)
                        if (c = g.matches[k], q ||!b.namespace&&!c.namespace || b.namespace_re && b.namespace_re.test(c.namespace)
                            )if (b.data = c.data, b.handleObj = c, c = ((d.event.special[c.origType] || {}).handle || c.handler).apply(g.elem, v), c !== h)b.result = c, c===!1 && (b.preventDefault(), b.stopPropagation())
                }
    ...
    (function(b, a) {
        ...
        ea + ")|[^:]|\\\\.)*|.*))\\)|)", ra = RegExp("^[\\x20\\t\\r\\n\\f]+|((?:^|[^\\\\])(?:\\\\.)*)[\\x20\\t\\r\\n\\f]+$", "g"), X = /^[\x20\t\r\n\f]*,[\x20\t\r\n\f]*/, da = /^[\x20\t\r\n\f]*([\x20\t\r\n\f>+~])[\x20\t\r\n\f]*/, U = RegExp(Q), aa = /^(?:#([\w\-]+)|(\w+)|\.([\w\-]+))$/, R = /[\x20\t\r\n\f]*[+~]/, ka = /h\d/i, Ga = /input|select|textarea|button/i, Y = /\\(?!\\)/g, V = {
            ID: /^#((?:\\.|[-\w]|[^\x00-\xa0])+)/,
            CLASS: /^\.((?:\\.|[-\w]|[^\x00-\xa0])+)/,
            NAME: /^\[name=['"]?((?:\\.|[-\w]|[^\x00-\xa0])+)['"]?\]/,
            TAG: RegExp("^(" + "(?:\\\\.|[-\\w]|[^\\x00-\\xa0])+".replace("w",
            "w*") + ")"),
            ATTR: RegExp("^" + ea),
            PSEUDO: RegExp("^" + Q),
    ...
    $a = d.expr.match.needsContext, Fb = {
        children: !0,
        contents: !0,
        next: !0,
        prev: !0
    ...
    d.fn.extend({
        find: function(b) {
            ...
            for (c = this.length; a < c; a++)
                if (e = f.length, d.find(b, this[a], f)
                    , a > 0)for (g = e; g < f.length; g++)
                for (l = 0; l < e; l++)
                    if (f[l] === f[g]) {
                        f.splice(g--, 1);
                        break
    ...
    Gb = / jQuery\d+="(?:null|\d+)"/g, Ia = /^\s+/, ab = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/gi, bb = /<([\w:]+)/, Hb = /<tbody/i, Ib = /<|&#?\w+;/, Jb = /<(?:script|style|link)/i, Kb = /<(?:script|object|embed|option|style)/i, Ja = RegExp("<(?:" + Oa + ")[\\s/>]", "i"), Pa = /^(?:checkbox|radio)$/, cb = /checked\s*(?:[^=]|=\s*.checked.)/i, Lb = /\/(java|ecma)script/i, Mb = /^\s*<!(?:\[CDATA\[|\-\-)|[\]\-]{2}>\s*$/g, ca = {
        ...
        area: [1, "<map>", "</map>"],
        _default: [0, "", ""]
    }, db = L(c), Ka = db.appendChild(c.createElement("div"));
    ...
    d.fn.extend({
        ...
        remove: function(b, a) {
            for (var c, e = 0; (c = this[e]) != null; e++)
                if (!b || d.filter(b, [c]).length)!a && c.nodeType === 1 && (d.cleanData(c.getElementsByTagName("*")), d.cleanData([c])
            ...
            if (this[0]) {
                ...
                p.length && d.each(p, function(b, a) {
                    a.src ? d.ajax ? d.ajax({
                        ...
                        global: !1,
                        "throws": !0
                    }) : d.error("no ajax") : d.globalEval((a.text || a.textContent || a.innerHTML || "").replace(Mb, ""));
    ...
    var W, oa, pa, La = /alpha\([^)]*\)/i, Nb = /opacity=([^)]*)/, Ob = /^(top|right|bottom|left)$/, Pb = /^(none|table(?!-c[ea]).+)/, eb = /^margin/, rb = RegExp("^(" + N + ")(.*)$", "i"), va = RegExp("^(" + N + ")(?!px)[a-z%]+$", "i"), Qb = RegExp("^([-+])=(" + N + ")", "i"), Da = {
        BODY: "block"
    }, Rb = {
        position: "absolute",
        visibility: "hidden",
        ...
        letterSpacing: 0,
        fontWeight: 400
    }, ja = ["Top", "Right", "Bottom", "Left"], Qa = ["Webkit", "O", "Moz", "ms"],
    Sb = d.fn.toggle;
    d.fn.extend({
        css: function(b, a) {
            ...
            if (b&&!(b.nodeType === 3 || b.nodeType === 8 ||!b.style)) {
                ...
                if (c !== h) {
                    ...
                    if (!(c == null || f === "number" && isNaN(c)))
                        if (f === "number" &&
                        !d.cssNumber[p] && (c += "px"), !j ||!("set"in j) || (c = j.set(b, c, e)) !== h)try {
                        q[a] = c
                    } catch (v) {}
                } else {
    ...
    d.extend({
        ...
        ajax: function(b, a) {
            function c(b, a, i, f) {
                ...
                if (t !== 2) {
                    ...
                    if (b >= 200 && b < 300 || b === 304)
                        if (m.ifModified && ((i = K.getResponseHeader("Last-Modified")) && (d.lastModified[e] = i), (i = K.getResponseHeader("Etag")) && (d.etag[e] = i)
                            ), b === 304)r = "notmodified", k=!0;
                    else {
                        a:
                        {
                            l = m;
                                                    ...
                                                    if (I!==!0)
                                                        if (I && l["throws"])
                                                            ...
                                                            try {
                                                                ...
                                                                k = {
                                                                    state: "parsererror",
                                                                    error: I ? F: "No conversion from " + N + " to " + i
                                                                };
                                                                break a
                                                            }
                                                        }
            ...
            var a = a || {}, e, g, f, j, p, q, v, o, m = d.ajaxSetup({}, a), u = m.context || m, s = u !== m && (u.nodeType || u instanceof d) ? d(u): d.event, $ = d.Deferred(), n = d.Callbacks("once memory"), z = m.statusCode || {}, r = {}, N = {}, t = 0, x = "canceled", K = {
                readyState: 0,
    ...
    var qa, Ca, ec = /^(?:toggle|show|hide)$/, fc = RegExp("^(?:([-+])=|)(" + N + ")([a-z%]*)$", "i"), gc = /queueHooks$/, xa = [function(b, a, c) {
        ...
        if (b.nodeType === 1 && ("height"in a || "width"in a))
            if (c.overflow = [m.overflow, m.overflowX, m.overflowY], d.css(b, "display") === "inline" && d.css(b, "float") === "none")!d.support.inlineBlockNeedsLayout || da(b.nodeName) === "inline" ? m.display = "inline-block" : m.zoom = 1;
        if (c.overflow)
        ...
        if (a = v.length) {
            ...
            for (e = 0; e < a; e++)
                if (g = v[e], j = q.createTween(g, u ? f[g] : 0)
                    , o[g] = f[g] || d.style(b, g), !(g in f) && (f[g] = j.start, u))j.end = j.start, j.start = g === "width" || g === "height" ? 1 : 0
        }
    }
    ], ta = {
        "*": [function(b, a) {
    ...
    d.speed = function(a, c, e) {
        var g = a && typeof a === "object" ? d.extend({}, a): {
    ...
    d.fn.offset = function(a) {
        ...
        if (f = (g = this[0]) && g.ownerDocument) {
            ...
            return {
                top: p.top + j - f,
                left: p.left + (g.pageXOffset || c.scrollLeft) - e
            }
        }
    };
    d.offset = {
    ...
    d.fn.extend({
        position: function() {
            if (this[0]) {
                var a = this[0], c = this.offsetParent(), e = this.offset(), g = nb.test(c[0].nodeName) ? {
                    top: 0,
                    left: 0
                }
                : c.offset();
...
(function(e, h, f, t) {
    var n = h.document, A = e(n), z = e(h), J = Array.prototype, E=!0, C=!1, L = navigator.userAgent.toLowerCase(), x = h.location.hash.replace(/#\//, ""), F = h.location.protocol, r = Math, D = function() {}, I = function() {
        return !1
    }, H = function() {
    ...
    T = h.parent !== h.self, U = function() {
        ...
        return {
                ...
                var a = function(a) {
                    ...
                    for (e = 0; c[e]; e++)
                        if (typeof a[c[e]] !== "undefined")
                            return c[e];
                    return !1
                }((n.body || n.documentElement).style), c = {
                ...
                return function(d, n, r) {
                    ...
                    m.join(",") + ")", h.setTimeout(function(a, d, c, j) {
                        return function() {
                            ...
                            }), q[0] || q[1]))a.data("revert", p), u.push("-webkit-transform" + j), g(a, "translate3d(" + q.join(",") + ")", "transform");
                            e.each(c, function(a) {
                                u.push(a + j)
                            });
                            g(a, u.join(","));
            ...
            removeAlpha: function(a) {
                ...
                c ? s.animate(a, h, {
                    ...
                    : f,
                    stop: !0
                }) : H < 9 && a ? (s.removeAlpha(a), a.style.visibility = "hidden") : g.css(h)
            }, show: function(a, c, f) {
                var f =
                f || D, g = e(a), a = g[0], h = {
                    opacity: parseFloat(g.data("opacity")) || 1
                };
                if (c) {
                    if (H < 9)
                ...
                var a = e.extend({
                    ...
                    timeout: 3E3
                }, a), c = s.timestamp(), j, g, v, o = function() {
                    g =
                    s.timestamp();
                    j = g - c;
                ...
                if (!(H !== 7 && H !== 8 ||!a || a.nodeName.toUpperCase() != "IMG"))typeof c === "undefined" && (c = a.style.msInterpolationMode === "nearest-neighbor")
                ...
                if (e("#" + c).length)
                    e("#" + c).attr("href", a), h--;
                else if (g = e("<link>").attr({
                    rel: "stylesheet",
                    href: a,
                    id: c
                }).get(0), c = e('link[rel="stylesheet"], style')
                    ,
        ...
        var a = function(a, f, g, h) {
            var o = this.getOptions("easing"), u = this.getStageWidth(), m = {
                left: u * (a.rewind?-1 : 1)
            }, n = {
                left: 0
            };
        ...
        return {
            ...
            effects: {
                fade: function(a, f) {
                    ...
                    a.prev && (e(a.prev).css("opacity", 1).show(), s.animate(a.prev, {
                        opacity : 0
                    }, {
                        duration : a.speed
                    }))
    ...
    f = function() {
        ...
        var c = this._keyboard = {
            ...
            animate: function() {
                ...
                }), s.animate(a.get("thumbnails"), {
                    left: c
                }, {
                    duration: a._options.carouselSpeed, easing: a._options.easing, queue: !1
                }))
            }
        }, v = this._tooltip = {
            initialized: !1,
            ...
            move: function(c) {
                ...
                !isNaN(e)&&!isNaN(d) && (e += 10, d -= f + 8, e = r.max(0, r.min(j, e)), d = r.max(0, r.min(m, d)), c < h && (d = h), g.css({
                    left: e,
                    top: d
                }))
            },
            ...
            enter: function(c) {
                o.beforeEnter(function() {
                    ...
                    a._options.trueFullscreen && X.support ? (o.active=!0, s.forceStyles(a.get("container"), {
                        width : "100%", height: "100%"
                    }), a.rescale(), f.MAC?!f.SAFARI ||!/version\/[1-5]/.test(L) ? (a.$("container").css("opacity", 0).addClass("fullscreen"), h.setTimeout(function() {
                        o.scale();
                ...
                var g = a.getData(), j = a._options, d=!a._options.trueFullscreen ||!X.support, m = {
                    height: "100%",
                    overflow: "hidden",
                    margin: 0,
                    padding: 0
                ...
                if (d) {
                    ...
                    s.forceStyles(a.get("container"), {
                        position: f.TOUCH ? "absolute": "fixed",
                        top: 0,
                        left: 0,
                        width: "100%",
                        height: "100%",
                ...
                T && o.iframe && (s.forceStyles(o.pd.documentElement, m), s.forceStyles(o.pd.body, m), s.forceStyles(o.iframe, e.extend(m, {
                    width: "100%",
                    height: "100%",
                    top: 0,
                    left: 0,
                ...
                if (e && (s.hide(a.getActiveImage()), s.revertStyles(a.get("container"), M().html, M().body), f.TOUCH || h.scrollTo(0, o.scrolled), (g = a._controls.frames[a._controls.active]) && g.image))g.image.src = g.image.src;
            ...
            hide: function() {
                if (a._options.idleMode && a.getIndex()!==!1) {
                    ...
                    e.each(u.trunk, function(e, g) {
                        var d = g.data("idle");
                        if (d)
                            g.data("idle").complete=!1, s.animate(g, d.to, {
            ...
            show: function(c) {
                ...
                if (!u.active ||!g.busy&&!g.complete)
                    g.busy=!0, a.trigger(f.IDLE_EXIT), a.clearTimer("idle"), s.animate(c, g.from, {
            ...
            init: function() {
                if (!m.initialized) {
                    m.initialized=!0;
                    var c = {}, g = a._options, j = "", g = {
                        overlay: "position:fixed;display:none;opacity:" +
                        g.overlayOpacity + ";filter:alpha(opacity=" + g.overlayOpacity * 100 + ");top:0;left:0;width:100%;height:100%;background:" + g.overlayBackground + ";z-index:99990",
            ...
            rescale: function(c) {
                var g = r.min(z.width()-40, m.width), j = r.min(z.height()-60, m.height), j = r.min(g / m.width, j / m.height), g = r.round(m.width * j) + 40, j = r.round(m.height * j) + 60, g = {
                    width: g,
                    height: j,
                    "margin-top": r.ceil(j / 2)*-1,
                    "margin-left": r.ceil(g / 2)*-1
                };
                c ? e(m.elems.box).css(g) : e(m.elems.box).animate(g, {
                    duration: a._options.lightboxTransitionSpeed,
                    easing: a._options.easing,
                    complete: function() {
                        var d = m.image, c = a._options.lightboxFadeSpeed;
                        a.trigger({
                            type: f.LIGHTBOX_IMAGE,
                            imageTarget: d.image
                        });
                        e(d.container).show();
                        e(d.image).animate({
                    ...
                    if (g.image && g.iframe) {
                        ...
                        e(d.image).css("cursor", "pointer").mouseup(function(a, d) {
                            return function(c) {
                                ...
                                "&autoplay=1" : ""), {
                                    width: "100%",
                                    height: H < 8 ? e(m.image.container).height(): "100%"
                                })
                            }
                        }(g, d))
                    }
    ...
    f.prototype = {
        ...
        _init: function() {
            ...
            this._options.swipe || e.each(Array(2), function(c) {
                ...
                e(g.container).css({
                    ...
                    top: 0,
                    left: 0
                }).prepend(a._layers[c] = e(s.create("galleria-layer")).css({
                    position: "absolute",
                    top: 0,
                    left: 0,
                    right: 0,
                ...
                var j = new f.Picture;
                j.isIframe=!0;
                e(j.container).attr("class", "galleria-frame").css({
                    position: "absolute",
                    top: 0,
                    left: 0,
                    zIndex: 4,
            ...
            if (c.swipe)
                this.$("images").css({
                    ...
                    width: 0,
                    height: "100%"
                }), this.finger = new f.Finger(this.get("stage"), {
                onchange: function(c) {
                ...
                if (c)
                    if (c.iframe) {
                        ...
                        e(g.container).find("iframe").length || (e(g.container).css({
                            width: f,
                            height: j,
                            opacity: 0
                        }).show().animate({
                            ...
                            g.load(c.iframe + (c.video ? "&autoplay=1" : ""), {
                                width: f,
                                height: j
                            },
                            function(e) {
                                ...
                                e.scale({
                                    ...
                                    iframelimit: c.video ? a._options.maxVideoSize: t
                                })
                            })
                        }, 100))
                } else if (c.link)
        ...
        _createThumbnails: function(a) {
            ...
            c) {
                ...
                v.trigger({
                    ...
                    thumbTarget: a.image,
                    index: a.data.order,
                    galleriaData: v.getData(a.data.order)
                });
            ...
            for (; this._data[u]; u++)
                j = this._data[u], a = j.thumb || j.image, (o.thumbnails===!0 || d == "lazy") && (j.thumb || j.image) ? (c = new f.Picture(u), c.index = u, c.displayed=!1, c.lazy=!1, c.video=!1, this.$("thumbnails").append(c.container), g = e(c.container), g.css("visibility", "hidden"), c.data = {
                width : s.parseValue(x("width")), height: s.parseValue(x("height")), order: u, src: a
            },
            o.thumbCrop!==!0 ? g.css({
                width: "auto",
                height: "auto"
            ...
            }), d == "lazy" ? (g.addClass("lazy"), c.lazy=!0, c.load(q, {
                height : c.data.height, width : c.data.width
            })) : c.load(a, I), o.preload === "all" && c.preload(j.image)) : j.iframe || d === "empty" || d === "numbers" ? (c = {
                container: s.create("galleria-image"),
                image: s.create("img", "span"),
                ready: !0,
                data: {
                    order: u
                }
            }, d === "numbers" && e(c.image).text(u + 1), j.iframe && e(c.image).addClass("iframe"), this.$("thumbnails").append(c.container), h.setTimeout(t(c.image, u, c.container), 50 + u *
            20)) : c = {
                container: null,
                image: null
            }, e(c.container).add(o.keepSource && o.linkSourceImages ? j.original : null).data("index", u).on(o.thumbEventType, E).data("thumbload", I), z === a && e(c.container).addClass("active"), this._thumbnails.push(c);
                    ...
                    if (a._options.swipe) {
                        ...
                        e.each(Array(a.getDataLength()), function(j) {
                            ...
                            e(g.container).css({
                                position: "absolute",
                                top: 0,
                                left: a._stageWidth * j
                            }).prepend(a._layers[j] = e(s.create("galleria-layer")).css({
                                position: "absolute",
                                top: 0,
                                left: 0,
                                right: 0,
            ...
            if (this._options.imageCrop!==!1) {
                ...
                H === 8 && (a.parent().scrollTop(m*-1).scrollLeft(u*-1), a.css({
                    top : 0, left : 0
                }));
            ...
            if (a = a || this._controls.getActive()) {
                var f, g = function(a) {
                    e(a.container).children(":first").css({
                        top: r.max(0, s.parseValue(a.image.style.top)),
                        left: r.max(0, s.parseValue(a.image.style.left)),
                        width: s.parseValue(a.image.width),
                        height: s.parseValue(a.image.height)
                    })
                }, c = e.extend({
                ...
                this._options.layerFollow && this._options.imageCrop!==!0 ? typeof c.complete == "function" ? (f = c.complete, c.complete = function() {
                    f.call(a, a);
                    g(a)
                }) : c.complete = g : e(a.container).children(":first").css({
                    top: 0,
                    left: 0
                });
                a.scale(c);
        ...
        resize: function(a, c) {
            ...
            (function() {
                ...
                g._controls.frames[g._controls.active].scale({
                    width: g._stageWidth,
            ...
            !this._options.queue && this._queue.stalled))
                if (a = r.max(0, r.min(parseInt(a, 10), this.getDataLength()-1)), c = typeof c !== "undefined"?!!c : a < this.getIndex()
                    , !j && f.History)f.History.set(a.toString());
            else {
                ...
                if (g) {
                    ...
                    if (!v)
                        return;
                    var s = this.isFullscreen() && v.big ? v.big: v.image || v.iframe, m = this._controls.slides[a], n = {
                        cached: m.isCached(s),
                        index: a,
                        rewind: c,
                        imageTarget: m.image,
                    ...
                    h.setTimeout(function() {
                        if (m.ready)
                            ...
                            if (v.iframe&&!v.image)
                                m.isIframe=!0;
                            m.load(s, function(a) {
                                o._scaleImage(a, p).trigger(e.extend(n, {
                                    type: f.IMAGE
                                }));
                                p()
                            })
        ...
        isFullscreen: function() {
            ...
            if (this._playing) {
                ...
                var h = function() {
                    c = s.timestamp() - e;
                    c >= a._playtime && a._playing ? (a.clearTimer(g), a.next()) : a._playing && (a.trigger({
                        type: f.PROGRESS,
    ...
    e.extend(f, {
        ...
        QUIRK: H && n.compatMode && n.compatMode === "BackCompat",
    ...
    f.raise = function(a, c) {
        ...
        h = function(a) {
            ...
            S.length || e("<div>").css(e.extend(g, {
                position: "fixed"
            })).append(h).appendTo(M().body)
        };
        if (E) {
            if (h(a), c)
                throw Error(f + ": " + a);
    ...
    f.Picture.prototype = {
        ...
        load: function(a, c, j) {
            typeof c == "function" && (j = c, c = null);
            if (this.isIframe) {
                var g = "if" + (new Date).getTime(), n = this.image = e("<iframe>", {
                    src: a,
                    frameborder: 0,
                    id: g,
                    allowfullscreen: !0,
        ...
        scale: function(a) {
            ...
            if (this.isIframe) {
                ...
                if (a.iframelimit) {
                    ...
                    h, a.iframelimit / g);
                    u < 1 ? (n = h * u, o = g * u, e(this.image).css({
                        top: g / 2 - o / 2,
                        left: h / 2 - n / 2,
                        position: "absolute"
                    })) : e(this.image).css({
            ...
            s.wait({
                ...
                success: function() {
                    var d = (z - a.margin * 2) / c.original.width, g = (p - a.margin * 2) / c.original.height, f = r.min(d, g), h = r.max(d, g), j = {
                        "true": h,
                        width: d,
                        height: g,
                        "false": f,
                        landscape: c.original.width > c.original.height ? h: f,
                        portrait: c.original.width < c.original.height ? h: f
                    }
                    [a.crop.toString()], d = "";
                    ...
                    e(c.image).css({
                        position: "absolute",
                        top: d(m.top, "height", p),
                        left: d(m.left, "width", z)
                    });
                    c.show();
                    c.ready=!0;
                    a.complete.call(c, c)
    ...
    f.Finger = function() {
        var a = f.HAS3D = function() {
            ...
            for (M().html.insertBefore(a, null);
            f[j];
            j++)h = f[j] ? f[j] + "Transform" : "transform", a.style[h] !== void 0 && (a.style[h] = "translate3d(1px,1px,1px)", c = e(a).css(f[j] ? "-" + f[j].toLowerCase() + "-transform" : "transform"));
    ...
    e.fn.galleria = function(a) {
        ...
        if (!e(this).length)
            return e(function() {
                e(c).length ? e(c).galleria(a) : f.utils.wait({
                    until: function() {
                        return e(c).length
                    },
                    success: function() {
...
var STATIC_URL = "/static/", G_DEMO_IMAGES = [{
    title: "Memory Maker",
    thumb: STATIC_URL + "i/s2013/2s.jpg",
    image: STATIC_URL + "i/s2013/2m.jpg",
    big: STATIC_URL + "i/s2013/2b.jpg",
    description: "A retro camera stilleben."
}, {
    title: "Athabasca Rail",
    thumb: STATIC_URL + "i/s2013/3s.jpg",
    image: STATIC_URL + "i/s2013/3m.jpg",
    big: STATIC_URL + "i/s2013/3b.jpg",
    description: "The Athabasca River railroad track at the mouth of Brul\u00e9 Lake in Alberta, Canada."
}, {
    title: "New York City",
    thumb: STATIC_URL + "i/s2013/4s.jpg",
    image: STATIC_URL +
    "i/s2013/4m.jpg",
    big: STATIC_URL + "i/s2013/4b.jpg",
    description: "Vintage skyline in New York City."
}, {
    title: "Works for Video too",
    video: "http://vimeo.com/25750735",
    thumb: "http://b.vimeocdn.com/ts/169/759/169759080_200.jpg",
    description: "Integrated API for YouTube, Vimeo and Dailymotion videos"
}, {
    title: "Interior convento",
    thumb: STATIC_URL + "i/s2013/5s.jpg",
    image: STATIC_URL + "i/s2013/5m.jpg",
    big: STATIC_URL + "i/s2013/5b.jpg",
    description: "Interior view of Yuriria Convent, founded in 1550."
}, {
    title: "Oxbow Bend outlook",
    thumb: STATIC_URL + "i/s2013/6s.jpg",
    image: STATIC_URL + "i/s2013/6m.jpg",
    big: STATIC_URL + "i/s2013/6b.jpg",
    description: "View over the Snake River to the Mount Moran with the Skillet Glacier."
}, {
    title: "Hazy blue hour",
    thumb: STATIC_URL + "i/s2013/7s.jpg",
    image: STATIC_URL + "i/s2013/7m.jpg",
    big: STATIC_URL + "i/s2013/7b.jpg",
    description: "Hazy blue hour in Grand Canyon. View from the South Rim."
}, {
    title: "Haute Severaisse valley",
    thumb: STATIC_URL + "i/s2013/8s.jpg",
    image: STATIC_URL + "i/s2013/8m.jpg",
    big: STATIC_URL + "i/s2013/8b.jpg",
    description: "View of Haute Severaisse valley and surrounding summits from the slopes of Les Vernets."
}, {
    title: "Bohinj lake",
    thumb: STATIC_URL + "i/s2013/9s.jpg",
    image: STATIC_URL + "i/s2013/9m.jpg",
    big: STATIC_URL + "i/s2013/9b.jpg",
    description: "Bohinj lake (Triglav National Park, Slovenia) in the morning."
}, {
    title: "Bowling Balls",
    thumb: STATIC_URL + "i/s2013/10s.jpg",
    image: STATIC_URL + "i/s2013/10m.jpg",
    big: STATIC_URL + "i/s2013/10b.jpg",
    description: "Mendocino county, California, USA."
}
];
(function(e, h, f, t) {
    (function(e) {
        ...
        views: {
            ...
            "theme-purchase": function() {
                var f = h("form.info"), n=!1, t=!1, C=!1, A = f.find(".vat").each(function() {
                    h(this).find("input").val().length || h(this).css({
                        position: "absolute",
                        left: "-100000px"
                    })
                ...
                !1, T = function() {
                    f.find("input[name=residence]").each(function() {
                        h(this).attr("checked") && (this.className == "sweden" && (U(), x=!1), this.className == "outside" && (aa(), x=!1), this.className == "addvat" && n ? (x=!0, t ? aa() : U(), A.css({
                            position: "static",
                            left: "auto"
                        }).find("input").focus()) : (this.className == "addvat"&&!n && (U(), x=!0), A.css({
                ...
                h("input[type=image]").each(function() {
                    F = F.toFixed(2);
                    var r = '<div class="total">Total: <span>' + (h(this).closest(".buy-form").hasClass("hasvat") ? "$" + F * 0.8 + " + $" + (F * 0.2).toFixed(2) + " VAT = <strong>$" + F : "<strong>$" + F) + "</strong></span></div>", D = h("<a>", {
                        href: "#",
                        html: "Buy Now",
                        click: function(r) {
                            r.preventDefault();
...
(function(e) {
    G.make(0, {
        ...
        init: function(h) {
            ...
            this.addIdleState(this.get("info"), z, Galleria.IE < 9 ? {} : {
                ...
                opacity: 1
            }, !0).addIdleState(this.get("counter"), J, Galleria.IE < 9 ? {} : {
                opacity: 0.9
            }, !0);
    ...
    G.make(1, {
        ...
        init: function(h) {
            ...
            var f = this, t = this.$("thumbnails-container"), n = this.$("thumblink"), A = this.$("fullscreen"), z = this.$("play"), J = this.$("popout"), E = this.$("bar"), C = this.$("progress"), L = h.transition, x = h._locale, F=!1, r=!1, D=!!h.autoplay, I=!1, H = function() {
                ...
                Galleria.utils.animate(t, {
                    top: F ? f.getStageHeight() + 30: 0
                }, {
                    easing: "galleria",
                    duration: 400,
                    complete: function() {
            ...
            H();
            h._showTooltip && f.bindTooltip({
                thumblink: x.show_thumbnails,
                fullscreen: x.enter_fullscreen,
                play: function() {
                    return D ? x.pause : x.play
                },
                popout: x.popout_image,
                caption: function() {
                    var e = f.getData(), h = "";
                    e && (e.title &&
            ...
            this.bind("fullscreen_enter", function() {
                ...
                Galleria.TOUCH || this.addIdleState(E, {
                    bottom: -31
                })
            });
            this.bind("fullscreen_exit", function() {
                ...
                Galleria.TOUCH || this.removeIdleState(E, {
                    bottom: -31
                })
            });
            this.bind("rescale", H);
    ...
    G.make(2, {
        ...
        init: function(h) {
            ...
            Galleria.TOUCH || (this.addIdleState(n, {
                opacity: 0
            ...
            if (h._hideDock)
                f.on("click:fast", this.proxy(function() {
                    ...
                    E ? n.animate({
                        top: C
                    }, 400, h.easing) : n.animate({
                        top: C - A.outerHeight() + 2
                    }, 400, h.easing);
                    E=!E
                }));
            else 
    ...
    G.make(3, {
        ...
        init: function(h) {
            ...
            t || (this.addIdleState(this.get("image-nav-left"), {
                left: -50
            }), this.addIdleState(this.get("image-nav-right"), {
                right: -50
    ...
    G.make(4, {
        ...
        init: function(h) {
            ...
            A = this.$("images"), z = this.$("info"), J = this.$("loader"), E = this.$("target"), C = 0, L = E.width(), x = 0, F = window.location.hash.substr(2), r = function(h) {
                f.$("info").css({
                    left: f.finger ? 20: Math.max(20, e(window).width() / 2 - h / 2 + 10)
                })
            }, D = function(f, h) {
                var h = e.extend({
                    speed: 400,
                    ...
                    delay: 0,
                    debug: !1
                }, h), f = e(f), n = f.children(), r = f.width(), t = Math.floor(r / h.width), z = [], x, C, A, r = {
                    "float": "none",
                    position: "absolute",
                ...
                t && (f.data("colCount", t), n.length)) {
                    ...
                    !(n < 0) && typeof n === "number" && (h.speed ? f.animate({
                        height: Math.max.apply(window, z)
                    }, h.speed, h.onheight) : (f.height(Math.max.apply(window, z)), h.onheight.call(f)))
                }
            };
            this.bind("fullscreen_enter", function() {
            ...
            this._fullscreen.beforeExit = function(e) {
                z.hide();
                Galleria.IE8 && Galleria.utils.animate(f.getActiveImage(), {
                    opacity: 0
                }, {
                    duration: 200
                });
                Galleria.utils.animate(t[0], {
                    opacity: 0
                }, {
                    duration: 200,
                    complete: function() {
            ...
            this.bind("thumbnail", function(r) {
                ...
                var z = r.thumbTarget, J = this.$("plus").css({
                    display: "block"
                }).insertAfter(z), F = e(z).parent().data("index", r.index);
                ...
                if (Galleria.TOUCH)
                    ...
                    function() {
                        Galleria.IE ? J.hide() : J.stop().animate({
                            opacity: 0
                        }, 300)
                    });
                C++;
                this.$("loaded").css("width", C / this.getDataLength() * 100 + "%");
                C === this.getDataLength() && (this.$("preloader").fadeOut(100), n.data("colCount", null), D(n, {
                    width: x,
                    speed: h._animate ? 400: 0,
                    onbrick: function() {
                        ...
                        window.setTimeout(function(r) {
                            return function() {
                                ...
                                function() {
                                    ...
                                    e.isFunction(h._onClick) ? h._onClick.call(f, f.getData(r)) : (t.css({
                                        visibility: "visible",
                                        opacity: 0
                                    }), f.$("target").height(f.$("target").height()), f.finger && A.css("opacity", 0), Galleria.utils.animate(n[0], {
                                        opacity: 0
                                    }, {
                                        duration: 100,
                                        complete: function() {
            ...
            !Galleria.TOUCH &&
            !h._webkitCursor && (this.addIdleState(this.get("image-nav-left"), {
                left: -100
            }), this.addIdleState(this.get("image-nav-right"), {
                right: -100
            }), this.addIdleState(this.get("info"), {
            ...
            e(window).resize(function() {
                if (f.isFullscreen())
                    ...
                    var e = E.width();
                    e !== L && (L = e, D(n, {
                        width : x, delay : 50, debug : !0, onheight : function() {
                            E.height(n.height())
                        }
                    }))
                }
    ...
    G.make(5, {
        ...
        init: function(h) {
            ...
            this.bindTooltip({
                ...
                desc: h._locale.click_to_close,
                more: h._locale.show_info,
                thumbs: h._locale.show_thumbnails
            });
            this.bind("loadstart", function(e) {
