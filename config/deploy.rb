...
set :application, 'childrenartschool'
set :deploy_to, '/var/www/apps/childrenartschool'
set :deploy_via, :copy
set :scm, :git
set :repo_url, 'git@github.com:sunstroke/childrenartschool.git'
set :branch, 'master'
application = 'childrenartschool'
set :rvm_type, :user
  ...
  task :foreman_init do
    on roles(:all) do
      ...
      within current_path do
        ...
        execute :bundle, "exec foreman export upstart #{foreman_temp} -a #{application} -u webmaster -l /var/www/apps/#{application}/log -d #{current_path}"
      end
