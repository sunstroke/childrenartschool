...
working_directory "/var/www/apps/childrenartschool/current" # available in 0.94.0+

# Слушаем Unix domain socket и TCP порт
listen "/var/www/apps/childrenartschool/socket/.unicorn.sock", :backlog => 64
...
pid "/var/www/apps/childrenartschool/run/unicorn.pid"

# Направляем потоки вывода
stderr_path "/var/www/apps/childrenartschool/log/unicorn.stderr.log"
stdout_path "/var/www/apps/childrenartschool/log/unicorn.stdout.log"
