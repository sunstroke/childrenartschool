...
Schoolf::Application.config.session_store :cookie_store, :key => '_schoolf_session'
Schoolf::Application.config.session = {
  :key          => '_schoolf_session',     # name of cookie that stores the data
...
# Schoolf::Application.config.session_store :active_record_store
